...
if __name__ == "__main__":
    ...
    log_dir = 'logs2/e2e/' + time + f'-{DS_NAME}-{CROPPED_H}x{CROPPED_W}_d{DISPARITIES}_IR-{INFER_RATE}_ITER-{INFER_ITER}_TR-{LEARN_RT}_BS-{BATCH_SIZE}_{NET}-supermodular'
    ...
    model.fit(dataset, callbacks=callbacks, epochs=2, initial_epoch=0)
